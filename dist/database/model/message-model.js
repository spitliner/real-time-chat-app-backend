...
async function getMessageMongo(messageId, messageChannel, readOnly) {
...
const messageModel = {
    async getMessage(messageId, messageChannel) {
    ...
    async editedMessage(messageId, messageChannel, messageAuthor, editedContent) {
        try {
    ...
    async deleteMessage(messageId, messageChannel) {
        try {
    ...
    async deleteMessageMany(messageAuthor, messageChannel) {
        try {
            return await messageMongoModel.deleteOne({
                channelId: messageChannel,
